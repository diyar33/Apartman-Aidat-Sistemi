...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Bilgi Verilen İşlemler Listesi
            </h3>
            <div class="page-bar">
...
">
      Bilgi Verilen İşlemler Sayfası
                        </a>
                    </li>
                </ul>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="portlet-body">
                                ...
                                <table  class="table table-striped table-bordered table-hover" id="sample_6">
                                    ...
                                    <?php
                                    $sql = mysqli_query($b," SELECT * FROM sikayet WHERE yetki='0' and islem='BİLGİ' order by apt");
...
';
echo '<td>
<span class="badge bg-green-soft">
'.$row["tar"].'
</span>
</td>
';
