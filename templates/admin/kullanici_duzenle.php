...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Kullanıcı Düzenleme Sayfası <small></small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Kullanıcı Düzenleme
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="kullanici_duzenle_control.php" method="post"  class="form-horizontal">
								<div class="form-body">
									...
									$query="select * from users where id='$kul_id'";
					 ...
					 ?>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="username" data-required="1" value="<?php echo $row["username"]; ?>" class="form-control"/>
										</div>
									</div>

										<input type="hidden" id="gizliDeger" name="kul_id" value="<?php echo $row["id"]; ?>"/>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input name="password" type="text" value="<?php echo $row["password"]; ?>" class="form-control"/>
										</div>
									</div>
