...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Kullanıcı Ekleme Sayfası <small></small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Kullanıcı Ekleme
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="kullanici_ekle_control.php" method="post"  class="form-horizontal">
								<div class="form-body">

									<?php if (!empty($_SESSION["add_user_info"]) && $_SESSION["add_user_info"]=="degerlerbos") {
									unset($_SESSION["add_user_info"]);
									 ?>
									...
									<?php if (!empty($_SESSION["add_user_info"]) && $_SESSION["add_user_info"]=="degerbosluklu") {
									unset($_SESSION["add_user_info"]);
									 ?>
									<div class="alert alert-warning ">
										<button class="close" data-close="alert"></button>
										Kullanıcı Adı boşluk karakteri içeremez.
									</div>
									<?php } ?>

								
									<?php if (!empty($_SESSION["add_user_info"]) && $_SESSION["add_user_info"]=="hatali") {
									unset($_SESSION["add_user_info"]);
									 ?>
									...
									<?php } ?>
										<?php if (!empty($_SESSION["add_user_info"]) && $_SESSION["add_user_info"]=="basarili") {
									unset($_SESSION["add_user_info"]);
									 ?>
...
<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<?php if (!empty($_SESSION["update_user_info"]) && $_SESSION["update_user_info"]=="degerlerbos") {
									...
									<?php if (!empty($_SESSION["update_user_info"]) && $_SESSION["update_user_info"]=="hatali") {
									unset($_SESSION["update_user_info"]);
									 ?>
									<div class="alert alert-danger ">
										<button class="close" data-close="alert"></button>
									...
									<div class="alert alert-warning ">
										<button class="close" data-close="alert"></button>
										Aynı kullanıcı adı birden fazla kullanılamaz.
									</div>
									<?php } ?>

										<?php if (!empty($_SESSION["update_user_info"]) && $_SESSION["update_user_info"]=="basarili") {
									unset($_SESSION["update_user_info"]);
									 ?>

									<div class="alert alert-success ">
										<button class="close" data-close="alert"></button>
										Kullanıcı Düzenleme İşlemi Başarılı
									</div>
									<?php } ?>
										...
										<?php if (!empty($_SESSION["delete_user_info"]) && $_SESSION["delete_user_info"]=="basarili") {
									unset($_SESSION["delete_user_info"]);
									 ?>
...
<?php 
						...
						if ($result->num_rows > 0) {
						    ...
						    while($row = $result->fetch_assoc()) {
						    	...
						    	echo '<td><a class="btn default" href=kullanici_duzenle.php?kul_id='.$row["id"].'>Düzenle </a></td>';
							    	echo '<td><a class="btn default" onclick="return confirm(\'Are you sure?\');" href=kullanici_sil.php?kul_id='.$row["id"].'>Sil </a></td>';
