							...
							<form   class="form-horizontal">
								<div class="form-body">
									...
									<?php } ?>
										...
										<label class="control-label col-md-3">GayriMenkul Adı</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-edit"></i>Sabit Giderler
                                </div>
                                <div class="tools">
                                    <a href="javascript:;" class="collapse">
                                    </a>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="btn-group">
                                                <a href="sabit_gider_ekle.php"><button id="sample_editable_2_new" class="btn green">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    if (!empty($_COOKIE["global_gm_id"]) ) {
                                        ...
                                        $sql = "select * from tb_sabit_gider inner join tb_anagayrimenkul on 
tb_anagayrimenkul.id=tb_sabit_gider.gm_id
where gm_id='$gayrimenkulid'";
                                        $result = $db->query($sql);
                                        $sayac=1;
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<td>'.$sayac.'</td>';
                                            echo '<td>' . $row["ad"] . '</td>';
                                            echo '<td>' . $row["gider_cinsi"] . '</td>';
                                            echo '<td>' . $row["yapilacak_is_ucreti"] . '</td>';
                                            if ( $row["dagitim_parametresi"]==1)
                                                echo '<td>Eşit</td>';
                                            else
                                                echo '<td>Arsa Payı</td>';
                                            if ( $row["dagitim_yeri"]==1)
                                                echo '<td>Tapu Sahibi</td>';
                                            else
                                                echo '<td>İkamet Eden</td>';
                                            echo '<td><a class="btn default" href=sabit_gider_duzenle.php?gd_id=' . $row["id"] . '><i class="glyphicon glyphicon-cog font-blue"> </i> </a></td>';
                                            echo '<td><a class="btn default" onclick="return confirm(\'Silmek İstediğinizden Eminmisiniz?\');" href=sabit_gider_sil.php?gd_id=' . $row["id"] . '><i class="glyphicon glyphicon-trash font-blue">
								 </i> </a></td></tr>';
                                            $sayac++;
                                        }
                                    }
							...
							<div class="portlet-body">
									...
									<div class="col-md-6">
										<div class="btn-group pull-right">
											<button id="sample_editable_1_new" onclick="window.location.href='sabit_gider_ekle.php'"  class="btn green" data-toggle="dropdown">Yeni Ekle <i class="fa fa-plus"></i>
											</button>
                                        </div>
...
$sayac=1;
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            if ( $row["dagitim_yeri"]==1)
                                                ...
                                                echo '<td>İkamet Eden</td>';
                                            echo '<td><a href="sabit_gider_detay.php?gd_id=' . $row["id"] . '" class="btn default btn-xs blue-stripe"> Detay </a></td>';
                                            echo '<td><a class="btn default" href=sabit_gider_duzenle.php?gd_id=' . $row["id"] . '><i class="glyphicon glyphicon-cog font-blue"> </i> </a></td>';
                                            echo '<td><a class="btn default" onclick="return confirm(\'Silmek İstediğinizden Eminmisiniz?\');" href=sabit_gider_sil.php?gd_id=' . $row["id"] . '><i class="glyphicon glyphicon-trash font-blue">
								 </i> </a></td></tbody>';
                                       $sayac++;
...
function sorgulamaFonksiyonu() {
    ...
    window.location='sabit_gider_listesi.php';
        }
</script>
