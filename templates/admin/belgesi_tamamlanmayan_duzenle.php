...
where tb_agm_g.id='$gd_id'";
                    ...
                    $sql2=mysqli_query($db,"select odeme_yer_id,odeme_tutar,ad from tb_odemeyer
inner join tb_firma on tb_firma.id=tb_odemeyer.odeme_yer_id
...
<form method='post'action='belgesi_tamamlanmayan_control.php?id=<?php echo $gd_id; ?>'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <select class="form-control input-medium select2me" name="belgenin_cinsi" id="belgenincinsi" data-placeholder="Seç..." required>
                                                           <option value=""></option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <input name="belgenin_serino" id="belgeninserino" value="<?php
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">
                                                        <input type="date" class="form-control" name="belgenin_tarihi" id="belgenintarihi" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="submit" class="btn green">
                                                         Gönder</button>
                                                    <button type="button" onclick="window.location='belgesi_tamamlanmayan.php';" class="btn green">
                                                        Geri Git                                                    </button>
