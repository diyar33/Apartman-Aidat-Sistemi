				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form  method="post" action="isletme_defteri_olustur.php" class="form-horizontal form-row-seperated">
								<div class="form-body">
									...
									<?php } ?>
										...
										<div class="col-md-4">
											<select id="select2_sample2" name="select2_sample2[]" class="form-control select2" multiple>
									...
									<div class="col-md-4">
										<div class="md-radio">
											<input type="radio" id="radio2" value="0" name="tip" class="md-radiobtn" checked>
											<label for="radio2">
											<span></span>
										...
										<div class="md-radio">
											<input type="radio" id="radio3" value="1" name="tip" class="md-radiobtn" >
											<label for="radio3">
											<span></span>
											<span class="check"></span>
											<span class="box"></span>
									...
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green" onclick="sorgulamaFonksiyonu()">Oluştur</button>
										</div>
									</div>
								</div>
